...
Ta zmiana może być zalążkiem tego, co starała się zrobić Paley. Przynajmniej część z nas i to już nie tylko z sektora publicznego, nie będzie mogła mówić: nie możesz się z nami bawić. 

To, co nadchodzi, kryje się pod jakże wdzięczną nazwą: [Ustawa z dnia 26 kwietnia 2024 r. o zapewnieniu spełniania wymagań dostępności niektórych produktów i usług przez podmioty gospodarcze](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20240000731). Na szczęście coraz częściej funkcjonuje ona jako "**Polski Akt o Dostępności**", i tego określenia będę tu używał (mimo, że to akt o dostępności niektórych produktów i usług) .
...
Przydatną lekturą poszerzającą wiedzę w tym zakresie może być [norma (standard) dostępności EN 301 549 w wersji 3.2.1 ](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/03.02.01_60/en_301549v030201p.pdf).

## A jak się to ma do projektowania inkluzywnego?

Wybierzmy się w góry (świetna metafora jeśli chodzi o dostępność, prawda?). Do takiej mentalnej wycieczki w swoim tekście [The Same, But Different: Breaking Down Accessibility, Universality, and Inclusion in Design](https://blog.adobe.com/en/publish/2018/04/02/different-breaking-accessibility-universality-inclusion-design) zaprasza czytelników Matt May.
...
>
>Universal design, by contrast, implies that reaching the summit is the true goal.
>
> Tłumaczenie: 
>Projektowanie inkluzywne to praktyka wspinania się na górę — zawsze możemy szukać sposobów, aby włączyć do naszych projektów więcej osób i sytuacji, nawet jeśli każdy krok pozwala nam przesunąć się tylko nieznacznie w górę szlaku.
>
>Z kolei projektowanie uniwersalne sugeruje, że prawdziwym celem jest dotarcie na szczyt.
...
Upewnij się, że różni ludzie mogą wejść w interakcję z Twoim rozwiązaniem/usługą. Dbaj o to, by mieli porównywalne doświadczenia, i mogli zyskać wartość bez względu na kim są i czego doświadczają. 

Przykład: [audiodeskrypcja](https://youtu.be/O7j4_aP8dWA?si=7syYeDykLX4dYiKS)

### Uwzględnij sytuację

Ludzie korzystają z tego, co dostarczasz po raz pierwszy, regularnie, w pracy, w domu, w podróży i pod presją czasu. Wszystkie te sytuacje (i wiele więcej) mogą mieć wpływ na ich wrażenia. 

Przykład: napisy w filmach, w sytuacji, gdy nie można słuchać dźwięku

### Bądź konsekwentna_y

Przekazuj te same informacje w ten sam sposób, a użytkownicy powinni móc robić te same rzeczy w ten sam sposób.

Przykład: uchwyty do drzwi sugerujące to, czy trzeba je ciągnąć czy pchać

### Daj ludziom kontrolę

Nie blokuj ani nie wyłączaj możliwości zmiany standardowych ustawień przeglądarki i platformy, takich jak orientacja ekranu, rozmiar czcionki, zoom i kontrast. Nie uruchamiaj treści audio/video automatycznie, chyba, że użytkownik_czka wcześniej tak zadecydowali.

Przykład: opcja wyłączenia automatycznego odtwarzania filmów

### Oferuj wybór

Zwykle istnieje więcej niż jeden sposób na wykonanie zadania. Pozwalaj ludziom wybierać między nimi.

Przykład: gest “swipe” by usunąć wiadomość lub przycisk usunięcia

### Priorytetyzuj treść

Pomóż ludziom skupić się na najważniejszych zadaniach, funkcjach i informacjach poprzez ich priorytetyzację w treści i układzie.

Przykład: oznaczenia akcji głównej i dodatkowej w interfejsie

### Dodawaj wartość

Wykorzystuj funkcjonalności systemów i urządzeń tak, by przynosiły ludziom wartość. Twórz rzeczy, które pracują dla ludzi. 

Przykład: wykorzystywanie lokalizacji w usługach transportu publicznego (gdzie jestem, kiedy przyjedzie tramwaj itp.)

Opracowanie na podstawie [Inclusive Design Principles](https://inclusivedesignprinciples.org/)

Microsoft, w swoim frameworku [Inclusive Design](https://inclusive.microsoft.design/) definiuje go, jako:
...
>Tłumaczenie:
>Projektowanie inkluzywne to metodologia wywodząca się z cyfrowych środowisk, która umożliwia uwzględnienie pełnego zakresu różnorodności ludzkiej. Najważniejszym aspektem jest angażowanie i uczenie się od osób reprezentujących różne perspektywy.

i wskazuje trzy zasady (aktywności):

1. **Rozpoznaj wykluczenie**
Uznajemy istnienie uprzedzeń i dostrzegamy wykluczenia, które pojawiają się w wyniku niedopasowania między ludźmi a ich doświadczeniami.

2. **Ucz się z różnorodności**
Projektowanie inkluzywne stawia ludzi w centrum całego procesu. Ich świeże, różnorodne perspektywy są kluczem do uzyskania prawdziwych i wartościowych wglądów.
...
Wśród automatycznych walidatorów, warto zwrócić uwagę na:
...
- Appt udostępniło swój przewodnik po dostępności: [Appt Accessibility Handbook](https://appt.org/en/handbook)
...
Jest takie cytowane przez wszystkich i przy prawie każdej okazji stwierdzenie przypisywane Peterowi Drucker'owi: 
>If you can’t measure it you can’t improve it. 
>Tłumaczenie:
>Jeśli nie możesz czegoś zmierzyć, nie możesz tego poprawić 

(nawiasem mówiąc co najmniej równie często pojawia się stwierdzeni: Jeśli nie możesz czegoś zmierzyć, nie możesz tym zarządzać)

Pomijając kwestie autorstwa tego cytatu (i jego brzmienia) warto mieć dane, które pozwalają zrozumieć, co się dzieje z dostępnością w naszym projekcie/produkcie. A jeszcze bardziej warto te dane wykorzystywać. 

#### Co mierzyć?

Standardowa odpowiedź w branży projektowej brzmi: to zależy. Ale tak na serio... to zależy od produktu nad którym pracujesz. Idealnie by pomiar dostępności nie był samotną wyspą, a wpisywał się w szerszy kontekst pomiaru produktu. Przykładem takiego holistycznego podejścia jest [Plaster Miodu Petera Morville'a](https://medium.com/mytake/the-ux-honeycomb-seven-essential-considerations-for-developers-accc372a398c).

Często też łączy się ze sobą pomiar użytecznośći i dostępności. Takie też podejście pojawia się w drafcie [WCAG 3.0](https://www.w3.org/TR/wcag-3.0/) i trudno mu odmówić słuszności. Tak jak trudno analizować użyteczność produktu w oderwaniu od dostępności (bo jak użyteczny może być produkt, który zamiast znosić, stawia bariery), tak samo zawężanie dostępności wyłącznie do kwestii zgodności z WCAG wcale nie pomaga w tworzeniu dostępnych produktów. 

Przystępując do takiego holistycznego pomiaru warto zastanowić się nad tym, jakie składniki mają się złożyć na niego. 

Przykładowo, w obszarze dostępności możemy wykorzystać:
- Badania i testy z osobami niepełnosprawnościami
- Heurystyki dostępności
- Dogfooding (zwłaszcza, jeśli w naszym zespole mamy osoby doświadczający jakiś wykluczeń)
- Szybkie testy dostępności
- Badanie zgodności z dobrymi praktykami i wytycznymi (innymi niż WCAG - np. Neurodiversity Design System)
- [AUS](https://makeitfable.com/accessible-usability-scale/)
- Testy automatyczne zgodności z WCAG
- zbieranie statystyk użycia różnych ustawień dostępności na urządzeniach mobilnych [Accessibility stats](https://appt.org/en/stats); [Gather your own accessibility data](https://appt.org/en/articles/gather-your-own-accessibility-data)
- zbieranie podobnych statystyk dla ston jest skomplikowanym i dosyć dyskusyjnym tematem: [How Many People With Disabilities Use My Website?](https://www.mightybytes.com/blog/how-many-users-with-disabilities-on-site/); [Can we use web analytics to improve accessibility?](https://medium.com/finn-no/can-we-use-web-analytics-to-improve-accessibility-54378a22e892); [Detecting screen readers in analytics](https://www.powermapper.com/blog/accessibility-analytics/); [Analytics Tools Can't Track Screen Readers — And Shouldn't](https://www.boia.org/blog/analytics-tools-cant-track-screen-readers-and-shouldnt); [Can we track how many users with disabilities access our site?](https://karlgroves.com/can-we-track-how-many-users-with-disabilities-access-our-site/)

Z kolei w obszarze użyteczności:
- Testy i badania z użytkownikami końcowymi
- Metryki zadań (np. wskaźnik sukces/porażka, czas na wykonanie zadania, liczba błędów)
- Metryki użyteczności (np. SUS, UMUX Lite) 
- Audyt użyteczności
- Checklisty heurystyk użyteczności i praw projektowych
- Dogfooding
...
**Warto zapamiętać** Nie używajcie wszystkich wymienionych tu metod pomiaru na raz i zawsze. Korzystajcie z nich, jak z klocków Lego by zbudować zestaw najlepiej dopasowany do waszych i waszych użytkowników/użytkowniczek potrzeb.

#### Jak wybrać swój zestaw pomiarowy?

Zastanów się co chcesz zbadać:
- jeśli chcesz zaangażować użytkowników końcowych, wybierz testy z ich udziałem
- jeśli chcesz skupić się na ocenie eksperckiej, idź w stronę heurystyk i audytów
- jeśli zależy Ci na zgodności z wytycznymi, warto rozważyć testy automatyczne  i manualne

Przykładowy miks:
- heurystyki użyteczności 
- wybrane szybkie testy dostępności
- automatyczne testy WCAG

#### Jak oceniać?

Ustal, jak zamieniasz wyniki testów/badań na ocenę punktową:
- całkiem dobrze działają skalę od zera (te z ujemnymi punktami są często trudne do zrozumienia i raportowania)
- część narzędzi (jak AUS) oferuje swoje skale, lub raportuje procent spełnienia wymagań (jak np. IBM Accessibility Checker)
- zastanów się czy i jak chcesz raportować globalne zestawienia składników

Przykład:
- spełnienie heurystyki - 2 pkt, częściowe spełnienie - 1 pkt, brak spełnienia - 0 pkt 
- zaliczony test dostępności - 2 pkt, z problemami 1 pkt, niezaliczony - 0 pkt
- procent zgodności z ocenianymi przez narzędzie aspektami WCAG 
- globalnie: punkty uzyskane/możliwych do uzyskania w każdym z narzędzi pomiaru 

#### Zdecyduj co dalej 

Pomiar bez jasnych wytycznych co zrobić z jego wynikami jest pomiarem dla pomiaru lub jak kto woli sztuką dla sztuki.

Ustal z zespołem co się dzieje, gdy wyniki wypadają źle, co gdy średnio. Jeśli dobrze, to nie ma się czym martwić :)

Przykład:
- Komponenty poniżej ustalonej liczby punktów (lub wyniku procentowego) w każdym z badanych aspektów nie są wdrażane
...
- [Proste testy dostępności](https://www.w3.org/WAI/test-evaluate/preliminary/)
- Wyniki automatycznego testu WCAG przy użyciu narzędzia [IBM Accessibility Checker](https://www.ibm.com/able/toolkit/verify/automated)

Wyniki tych pomiarów są raportowane globalnie procentowo (liczba uzyskanych punktów do najwyższego możliwego wyniku w ocenianych kryteriach).
...
Tekst ten powstał jako materiał towarzyszący Masterclass [Projektowanie Inkluzywne](https://ationcenter.com/masterclasses/projektowanie-inkluzywne/)
